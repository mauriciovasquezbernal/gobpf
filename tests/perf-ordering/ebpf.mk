...
build:
	...
	clang -D__KERNEL__ -D__ASM_SYSREG_H \
		...
		-Wall \
		-Werror \
		-O2 -emit-llvm -c gettimeofday-bpf.c \
		...
		-o - | llc -march=bpf -filetype=obj -o "${DEST_DIR}/gettimeofday-bpf.o"
	go-bindata -pkg tracer -prefix "${DEST_DIR}/" -modtime 1 -o "${DEST_DIR}/gettimeofday-bpf.go" "${DEST_DIR}/gettimeofday-bpf.o"
